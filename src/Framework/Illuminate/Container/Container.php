...
use SagoBoot\Framework\Illuminate\Contracts\Container\Container as ContainerContract;
...
class Container implements ContainerContract
{
    ...
    public function make($abstract, $parameters = [])
    {
        ...
        // Before check for shared let check allow dynamic sharable
	    if ($this->isSingleton($object) && !isset($this->bindings[ $abstract ])) {
	    	$shared = true;
		    $this->bindings[ $abstract ] = compact('concrete', 'shared');
	    }
	 ...
	 * @return bool
	 */
    protected function isSingleton($concrete)
    {
	    return $concrete instanceof \SagoBoot\Framework\Illuminate\Contracts\Singleton\Autoload;
    }
