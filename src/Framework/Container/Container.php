...
namespace SagoBoot\Framework\Container;
...
/**
 * Class Container
 * @package SagoBoot\Framework\Container
 */
class Container implements ContainerContract
{
    ...
    public function make($abstract, $parameters = [])
    {
        ...
        if ($this->isShared($abstract) || (!isset($this->bindings[ $abstract ]['shared']) && $this->isSingleton($object))) {
    ...
    {
	    return $concrete instanceof \SagoBoot\Framework\Contracts\Singleton;
    }
